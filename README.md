...
1. Amygdala activates the threat response
2. Sympathetic nervous system triggers fight-or-flight response 
...
3. Response Protocol Generator  
   - Selects an intervention style based on stress category level
